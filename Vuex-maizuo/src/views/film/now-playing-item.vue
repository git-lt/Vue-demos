      ...
      <div class="film-item">
        ...
        <div class="film-desc">
          ...
          <div class="film-counts">
            <span class="film-count-color1">{{film.cinemaCount}}</span><span>家影院上映&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            <span class="film-count-color1">{{film.watchCount}}</span><span>人购票  </span>
          </div>
        </div>
      </div>
    </router-link>
