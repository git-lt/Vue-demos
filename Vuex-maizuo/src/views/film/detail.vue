  ...
  <section class="content film-view">
    ...
    <div class="film-intro">
      ...
      <div class="film-word2">
        ...
        <span>(</span><span>{{detail.language}}</span><span>)</span>
      </div>
      <div class="film-word2">
        <span>类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;型：</span>
      ...
      <div class="film-word2">
        <span>上映日期：</span>
        <span>{{getTime(detail.premiereAt)}}</span>
      </div>
      <div class="film-word3">{{detail.synopsis}}</div>
    </div>
    <div class="operation">
...
export default {
  ...
  computed:{
    ...
    actors(){
      let actors = ''
      this.detail.actors && this.detail.actors.forEach( actor => {
        actors += actor.name + ' | '
      })
      return actors
    }
